                ...
                <div class="container">
                        <div class="primary-menu text-right">
                              <ul>
                                    ...
                                    <li>
                                          <img src="assets/css/images/avatar1.jpg" style="color:#b50707;"/>
              ...
              <div class="container">
                  ...
                  <!-- FORM-SEARCH BOX HOTEL WITH FILTERS  -->
                    <aside class="hotel-search box">
                        <form name="searchForm" method="get" class="searchForm" action="">
                        ...
                        <section>
                            <section>
                                ...
                                ?>
                                  ...
                                  <article class="hotel">
                                      <aside class="media">
                                         <img src="assets/images/<?php echo $availableRoom['photo_url']; ?>" alt="Room" width="100%" height="auto">
                                          <div class="overlay">
